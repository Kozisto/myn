...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mynt-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mynt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mynt transaction") + "\n" +
              "  mynt-tx [options] -create [commands]   " + _("Create hex-encoded mynt transaction") + "\n" +
              "\n";
