...
enum WalletFeature
{
    FEATURE_BASE = 50000, // the earliest version new wallets supports (only useful for getwalletinfo's clientversion output)
    ...
    FEATURE_HD_SPLIT = 50000, // Wallet with HD chain split (change outputs will use m/0'/1'/k)

    FEATURE_NO_DEFAULT_KEY = 50000, // Wallet without a default key written

    FEATURE_LATEST = 50000
};
