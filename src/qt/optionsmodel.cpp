...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::MYNT);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();

    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "http://explorer.myntcurrency.org:3001/tx/%s");
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://explorer.myntcurrency.org:3001/tx/%s").toString();
