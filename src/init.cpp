...
{
    const std::string URL_SOURCE_CODE = "<https://bitbucket.org/myntcurrency/mynt-core/>";
    const std::string URL_WEBSITE = "<https://myntcurrency.org>";
