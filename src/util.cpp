...
const char * const BITCOIN_CONF_FILENAME = "mynt.conf";
const char * const BITCOIN_PID_FILENAME = "mynt.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Mytnt";
#else
    // Unix
    return pathRet / ".mynt";
#endif
...
void ArgsManager::ReadConfigFile(const std::string& confPath)
{
    ...
    if (!streamConfig.good())
        return; // No mynt.conf file is OK
...
{
	std::string prefix2014 = strPrefix;					//MYNT
	size_t index2009 = strPrefix.find("2009");
	if (index2009 != std::string::npos)
		prefix2014.replace(index2009, 5, "");
