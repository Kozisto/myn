...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the mynt repository."
  exit 1
fi
...
BDB_URL="https://www.myntcurrency.org/${BDB_VERSION}.tar.gz"
...
CLANG_CXX11_PATCH_URL='https://www.myntcurrency.org/clang.patch'
...
echo
echo 'When compiling myntd, run `./configure` in the following way:'
echo
