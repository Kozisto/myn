...
[Bitcoin mynt-cli repository](https://github.com/bitcoin/bitcoin) but are not part of
...
them from the mynt-cli repository where you retrieved this file.

Sources 100+ are for files that are not source tarballs and are not maintained
in the bitcoin mynt-cli repository. At present only an SVG version of the Bitcoin
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the Bitcoin mynt-cli
master branch.
