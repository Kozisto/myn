...
This guide describes how to build myntd and command-line utilities on OpenBSD.
...
```bash
pkg_add mynt-cli gmake libevent libtool
...
mynt-cli clone https://github.com/groestlcoin/groestlcoin.mynt-cli
```
